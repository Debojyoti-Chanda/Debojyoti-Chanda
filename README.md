...
## 🌐 Socials:
[![LinkedIn](https://img.shields.io/badge/LinkedIn-%230077B5.svg?logo=linkedin&logoColor=white)](https://www.linkedin.com/in/debojyoti-c/)
[![X](https://img.shields.io/badge/X-black.svg?logo=X&logoColor=white)](https://x.com/debojyoti_100)
...
![gRPC](https://img.shields.io/badge/gRPC-%230F9D58.svg?style=for-the-badge&logo=google&logoColor=white)
...
![CI/CD](https://img.shields.io/badge/CI%2FCD-%232C5263.svg?style=for-the-badge&logo=githubactions&logoColor=white)
...
> Java · Spring Boot · Spring Cloud Gateway · gRPC/Protobuf · Apache Kafka · PostgreSQL · Docker

A full microservices backend (Auth, API Gateway, Patient, Billing, Analytics) with JWT authentication, gRPC inter-service communication, and an event-driven analytics pipeline using Kafka. Fully containerized with Docker Compose.

---

#### 💳 Credit Card Portfolio Retention — Predictive Analytics
> Python · Pandas · Scikit-learn · Matplotlib

EDA on real banking datasets + Logistic Regression & Random Forest models achieving **90% accuracy**, improving customer retention forecasts by **25%**.

---

### 🏆 Certifications & Achievements

- ☁️ **AWS Cloud Technical Essentials** — Amazon Web Services
- 🗄️ **HackerRank SQL (Intermediate)** Certification
- 📄 **Conference Paper** presented at IC3Com, UEM Jaipur (300+ attendees) — on optimization algorithms for energy minimization in surveillance video
- 🤖 **Fibe: Hack the Vibe! 2.0 ML Hackathon** (HackerEarth) — Top ranked among 800+ participants; built NLP classifier with 79% accuracy
